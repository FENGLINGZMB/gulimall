package com.fenglingzmb.gulimall.product.controller;

import java.util.Arrays;
import java.util.Map;

import com.fenglingzmb.common.valid.AddGroup;
import com.fenglingzmb.common.valid.UpdateGroup;
